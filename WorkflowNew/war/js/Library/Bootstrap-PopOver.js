 ...
 "use strict"
  ...
  , show: function () {
      ...
      if (this.hasContent() && this.enabled) {
        ...
        var offset2 = this.options.offset2 || 0;
        ...
        switch (inside ? placement.split(' ')[1] : placement) {
          ...
          case 'left':
            ...
            break
          case 'right':
            console.log( pos.top  + ' + ' +  pos.height / 2 + ' - ' + actualHeight / 2 + ' + ' + offset1 );
            tp = {top: pos.top + pos.height / 2 - actualHeight / 2 + offset1, left: pos.left + pos.width + offset2 }
            break
        }
