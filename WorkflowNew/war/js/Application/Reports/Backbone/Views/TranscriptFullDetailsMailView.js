BackboneData.TranscriptFullDetailsMailView	= 		Backbone.View.extend( {

	isRendered 						: 			false,

	fetchedAccount 					: 			null,

	origin 							: 			'TranscriptFullDetailsMailView',
	...
	render 							: 			function() {
													...
													var htmlString = acti.workflow.reports.transcriptFullDetailMail( { attributes: { test: 'TEST', messages: messageArray, messageDetails: { domainName: Helper.getDisplayDomainName(self.transcriptModel.get( 'domain' )), userImage: 'images/user-icon.jpg', from: self.transcriptMessageObject.FROM, to: self.transcriptMessageObject.TO, } } } );
